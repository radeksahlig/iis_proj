    ...
    <main class="container">
        <section class="row justify-content-md-center">
            <div class="col col-md-10">
                <div class="card shadow-lg border-dark">
                    ...
                    <div class="col col-md-6 mt-4">
                        <a class="mb-2 badge badge-light" href="./accounts.php">Všechny účty</a>
                        <br>
                        <form method="get" action="" enctype="multipart/form-data">
                        <div class="input-group">
                            <input class="form-control" type="text" name="search" required="required" id="srch" placeholder="Zadaj hledaný účet" aria-label="search" aria-describedby="srch" />
                            <div class="input-group-append">
                                <input type="submit" value="Hledat" id="srch" class="btn btn-primary float-right" />
                            </div>
                        </div>
                        </form>
                        <?php
                            ...
                            echo "<span>Výpis uživatelů $offset - ".($offset+10) . "</span></span>";
                        ?>
                    </div>
                <div class="card-body">
            <?php
            ...
            if($load_accounts->num_rows>0){
                ...
                echo "<br>";
                echo "<p class='mt-4 alert alert-danger text-center border-danger'>Nepodařilo se načíst žádné účty!</p>";
            }
            $load_accounts->close();
            $db->close();
